#!/bin/bash
#
# gcm.sh: Test for Testing GCM mode.
...
etl_lmount || exit
# TODO: Simplify this.
default_mount_opts="rw,relatime,ecryptfs_cipher=aes,ecryptfs_cipher_mode=gcm,ecryptfs_key_bytes=16,ecryptfs_sig=\${ETL_FEKEK_SIG}"
